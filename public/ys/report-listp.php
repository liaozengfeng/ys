<?php
	...
	$sql="select * from y_user_homework Join y_homework_list on y_homework_list.hid = y_user_homework.hid Join y_user on y_user.uid = y_user_homework.uid where y_homework_list.etype =1";
	$list = selectAll($sql);
?>
<!DOCTYPE HTML>
<html>
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','correct.php','<? echo $circle["huid"]; ?>')" href="javascript:;" title="编辑">批改</a>
					</td>
				</tr>
