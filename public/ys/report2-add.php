...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>大作文标题：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">大作文内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				type: "POST",
				url:urlFix+"<?php if(!isset($_GET["id"])){ echo "reportAdd2";}else{echo "reportEdit2";}; ?>", 
				cache: false,
				data:oMyForm,
				processData: false,
				contentType: false,
