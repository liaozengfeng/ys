...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			...
			<a class="btn btn-primary radius" data-title="添加轮播图" data-href="banner-add.php" onclick="Hui_admin_tab(this)" href="javascript:;">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				...
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td class="newsid"><? echo $banner["bannerId"]; ?></td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','banner-add.php','<? echo $banner["bannerId"]; ?>')" title="查看"><?php echo $banner["bannerTitle"]; ?></u></td>
					<td><image src='<?php echo $banner["bannerCover"]; ?>' style='width:100px' /></td>
					<td><?php echo date("Y-m-d H:i:s",$banner["updateTime"]); ?></td>
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('轮播图编辑','banner-add.php','<? echo $banner["bannerId"]; ?>')" href="javascript:;" title="编辑">编辑</a>
						<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'<? echo $banner["bannerId"]; ?>')" href="javascript:;" title="删除">删除</a>
					</td>
				</tr>
