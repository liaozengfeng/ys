...
<article class="page-container">
	<div class="form form-horizontal" id="form-article-add">
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>大作文：</label>
		...
		<div class="row cl">
		 <label class="form-label col-xs-4 col-sm-2">大作文长图：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：切题</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Aarr['TR'][0]['content']; ?>" placeholder="" id="tr01" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：完整回应题目</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：立场贯穿一致</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：论点重心平衡</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：细节论证充分</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：中文思想准确</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Aarr['TR'][5]['content']; ?>" placeholder="" id="tr06" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>TR：结论段水平</label>
			<div class="formControls col-xs-8 col-sm-9">
...
function upload(){
	...
	$.ajax({
		type: "POST",
		url:urlFix+"<?php if($_GET["id"]){ echo "correctReport2";}else{echo "correctReport2";}; ?>", 
		cache: false,
		data:oMyForm,
		processData: false,
		contentType: false,
