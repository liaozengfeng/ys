<?php
	...
	$sql="select * from y_homework_list where etype = 3";
	$list = selectAll($sql);
?>
<!DOCTYPE HTML>
<html>
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			...
			<a class="btn btn-primary radius" data-title="添加口语作业" data-href="speak-add.php" onclick="Hui_admin_tab(this)" href="javascript:;">
				<i class="Hui-iconfont">&#xe600;</i> 添加口语作业
			</a>
		</span> 
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','speak-add.php','<? echo $circle["hid"]; ?>')" href="javascript:;" title="编辑">编辑</a>
