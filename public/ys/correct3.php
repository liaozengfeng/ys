...
<article class="page-container">
	<div class="form form-horizontal" id="form-article-add">
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>口语：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<?php $svc =json_decode($s['audio'],true); $all=count($svc);?> 
				 <?php for($i=0;$i<$all;$i++){ ?>
				     <div> Part
					 <?php if($i<=3){  echo "1-".($i+1);}else if($i==4){ echo "2";}else{ echo "3-".($i-4);} ?>  
					 </div>
					 <audio controls>
                         <source src="<?php echo $svc[$i]['url']; ?>" type="audio/mp3">
                        您的浏览器不支持 audio 元素。
                    </audio>			 
				 <?php }?>
			</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC分数：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC：恰当的展开话题</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Aarr['TR'][0]['content']; ?>" placeholder="" id="tr01" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC：表达详尽</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC：表达连贯程度,衔接语句使用</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC：表达流利度</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>FC：自我纠正的情况</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> FC：正确的使用词句</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PR分数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo  $sv['BScore']; ?>" placeholder="" id="ccScore" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PR：发音特点：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PR：口音对听者理解的影响：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Barr['TR'][1]['content'];?>" placeholder="" id="cc02" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PR：发音的清晰度：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Barr['TR'][2]['content'];?>" placeholder="" id="cc03" name="">
			</div>
		</div>		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PR：发音的准确性：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>LR 改诉的有效性：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $Carr['TR'][3]['content']; ?>" placeholder="" id="lr04" name="">
			</div>
		</div>			
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Others内容逻辑：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Others表达理解：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
function upload(){
	...
	if(!$('#lr04').val()){ $.Huimodalalert('请完善内容！',2000);return;}
	...
	$.ajax({
		type: "POST",
		url:urlFix+"<?php if($_GET["id"]){ echo "correctReport3";}else{echo "correctReport3";}; ?>", 
		cache: false,
		data:oMyForm,
		processData: false,
		contentType: false,
